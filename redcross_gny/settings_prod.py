...
EMAIL_HOST = get_secret('REDCROSS_GNY_EMAIL_HOST')
EMAIL_PORT = int(get_secret('REDCROSS_GNY_EMAIL_PORT'))
EMAIL_HOST_USER = get_secret('REDCROSS_GNY_EMAIL_HOST_USER')
EMAIL_HOST_PASSWORD = get_secret('REDCROSS_GNY_EMAIL_HOST_PASSWORD')
EMAIL_USE_TLS = eval(get_secret('REDCROSS_GNY_EMAIL_USE_TLS'))
EMAIL_USE_SSL = eval(get_secret('REDCROSS_GNY_EMAIL_USE_SSL'))
SERVER_EMAIL = get_secret('REDCROSS_GNY_EMAIL_FROM_USER')
DEFAULT_FROM_EMAIL = SERVER_EMAIL


# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/1.7/howto/static-files/
STATIC_ROOT = '/home3/ulsterc3/public_html/subdomains/arc/gny/static'
MEDIA_ROOT = '/home3/ulsterc3/public_html/subdomains/arc/gny/uploads'
MEDIA_URL = '/uploads/'
STATIC_URL = '/static/'
...
EMAIL_SUBJECT_PREFIX = '[REDCROSS-GNY]'
